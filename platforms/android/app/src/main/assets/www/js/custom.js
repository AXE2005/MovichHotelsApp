$(window).on("load", function () {
	...
	}, 450); // will fade out the white DIV that covers the website.
});
...
$(document).ready(function () {
	...
	function init_template() {
		...
		$(".menu-box-top").each(function () {
			...
			$(this).css(
				"-webkit-transform",
				"translate(0%, " + menuBoxHeight * -1 + "px)"
			);
		});
		...
		$("[data-menu]").on("click", function () {
			$(".menu").removeClass(
				"active-menu-box-top active-menu-box-bottom active-menu-box-modal active-menu-full active-sidebar-left-over active-sidebar-left-push active-sidebar-right-push active-sidebar-left-parallax active-sidebar-right-parallax active-sidebar-right-over"
			);
			$(".page-content, .header").removeClass(
				"active-body-left-push active-body-right-push active-body-left-parallax active-body-right-parallax"
			);
			$(".menu").css({ "margin-top": "" });
			...
			if (menuType === "menu-sidebar-left-over") {
				$("#" + menuID)
					.toggleClass("active-sidebar-left-over")
					.addClass("menu-sidebar-shadow");
			}
			if (menuType === "menu-sidebar-left-push") {
				$("#" + menuID).toggleClass("active-sidebar-left-push");
				$(".page-content, .header").toggleClass("active-body-left-push");
			}
			if (menuType === "menu-sidebar-left-parallax") {
				$("#" + menuID)
					.toggleClass("active-sidebar-left-parallax")
					.addClass("menu-sidebar-shadow");
				$(".page-content, .header").toggleClass("active-body-left-parallax");
			}
			if (menuType === "menu-sidebar-right-parallax") {
				$("#" + menuID)
					.toggleClass("active-sidebar-right-parallax")
					.addClass("menu-sidebar-shadow");
				$(".page-content, .header").toggleClass("active-body-right-parallax");
			}
			if (menuType === "menu-sidebar-right-over") {
				$("#" + menuID)
					.toggleClass("active-sidebar-right-over")
					.addClass("menu-sidebar-shadow");
			}
			if (menuType === "menu-sidebar-right-push") {
				$("#" + menuID).toggleClass("active-sidebar-right-push");
		...
		$(".menu-hider, .close-menu, .menu-bar").on("click", function () {
			...
			$(".page-content, .header").removeClass(
				"header-zindex active-body-left-push active-body-right-push active-body-left-parallax active-body-right-parallax"
			);
			$(".menu").css({ "margin-top": "" });
		...
		$(window).on("scroll", function () {
			...
			var footer_reached =
				$(this).scrollTop() >= total_scroll_height - ($(window).height() + 600);
		...
		setTimeout(function () {
			...
			$(".next-slide, .next-slide-arrow, .next-slide-text, .next-slide-custom").on(
				"click",
				function () {
					$(this).parent().find(".owl-carousel").trigger("next.owl.carousel");
				}
			);
			$(".prev-slide, .prev-slide-arrow, .prev-slide-text, .prev-slide-custom").on(
				"click",
				function () {
		...
		$(".gallery-filter-controls li").on("click", function () {
			$(".gallery-filter-controls li").removeClass(
				"gallery-filter-active color-blue-dark"
			);
		...
		if (isMobile.iOS()) {
			...
			$(".show-blackberry, .show-android, .show-windows, .show-download").addClass(
				"disabled"
			);
			$(".set-today").addClass("mobile-date-correction");
		}
		...
		$(".shareToFacebook").prop(
			"href",
			"https://www.facebook.com/sharer/sharer.php?u=" + share_link
		);
		$(".shareToGooglePlus").prop(
			"href",
			"https://plus.google.com/share?url=" + share_link
		);
		$(".shareToTwitter").prop(
			"href",
			"https://twitter.com/home?status=" + share_link
		);
		$(".shareToPinterest").prop(
			"href",
	...
	$("body").append(
		'<div class="page-change-preloader preloader-light"><div id="preload-spinner" class="spinner-red"></div></div>'
	);
});
